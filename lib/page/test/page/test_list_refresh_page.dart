...
class TestListRefreshPage extends StatefulWidget {
  const TestListRefreshPage({super.key});

  @override
  State<StatefulWidget> createState() => _TestListRefreshPageState();
}

class _TestListRefreshPageState extends State<TestListRefreshPage> {
  List<String> _data = [];
